...
if [[ ${gaplocation2} != "" &&  ${gaplocation2} < 270 && ${gaplocation3} != "" &&  ${gaplocation3} > 270 ]]; then
	...
	allele15=`echo ${flagment5}${gapflagment}${flagment6}${flagment7}${gap1flagment}${flagment4}`
        ...
        grep -B1 "$allele9$" ../../database/HLA-I_II_GEN.fasta >> a.out
        grep -B1 "$allele10$" ../../database/HLA-I_II_GEN.fasta >> a.out
        grep -B1 "$allele11$" ../../database/HLA-I_II_GEN.fasta >> a.out
        grep -B1 "$allele12$" ../../database/HLA-I_II_GEN.fasta >> a.out
        grep -B1 "$allele13$" ../../database/HLA-I_II_GEN.fasta >> a.out
        grep -B1 "$allele14$" ../../database/HLA-I_II_GEN.fasta >> a.out
        grep -B1 "$allele15$" ../../database/HLA-I_II_GEN.fasta >> a.out
        grep -B1 "$allele16$" ../../database/HLA-I_II_GEN.fasta >> a.out
