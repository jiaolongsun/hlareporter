...
samtools view -b -L $2.bed $1_exon23_high_resolution_multi_ref_mappedreads_sorted.bam > $1_exon23_high_resolution_multi_ref_mappedreads_target_flanking.bam
...
./HPTASRwgs_classI-II_flankingII_recursive1.sh $1 $2
...
./report_hla.sh $1 $2 > report.out

./phase_analyserII.sh $1 $2
