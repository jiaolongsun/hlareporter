###Run TASR
echo "Running TASR..."
../bin/TASR -f patient.fof -m 50 -o 5 -r 0.9 -s ../database/HLA-I_II_GEN.fasta -i 1 -b TASRhla
...
../bin/HLAminer.pl -z 90 -i 100 -b tig_vs_hla-ncbi.coord -r hla_vs_tig-ncbi.coord -c TASRhla90.contigs -h ../database/HLA-I_II_GEN.fasta
